...
**File:** `src/agent-knots/intervention.py`
...
**File:** `src/agent-knots/session/features.py` (`inject_memory`)
...
**File:** `src/agent-knots/session/features.py` (`make_delegate_tool`)
...
**File:** `src/agent-knots/session/features.py` (`save_checkpoint`, `load_checkpoint`)
...
**File:** `src/agent-knots/session/features.py` (`register_steering_hook`)
...
**File:** `src/agent-knots/session/features.py` (`validate_task_output`)
