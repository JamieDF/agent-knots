...
**File:** `src/agentjam/intervention.py`
...
**File:** `src/agentjam/session/features.py` (`inject_memory`)
...
**File:** `src/agentjam/session/features.py` (`make_delegate_tool`)
...
**File:** `src/agentjam/session/features.py` (`save_checkpoint`, `load_checkpoint`)
...
**File:** `src/agentjam/session/features.py` (`register_steering_hook`)
...
**File:** `src/agentjam/session/features.py` (`validate_task_output`)
